...
MONGODB_BACKUP_HOST=${MONGODB_BACKUP_HOST}
MONGODB_BACKUP_PORT=${MONGODB_BACKUP_PORT_27017_TCP_PORT:-${MONGODB_BACKUP_PORT}}
MONGODB_BACKUP_PORT=${MONGODB_BACKUP_PORT_1_27017_TCP_PORT:-${MONGODB_BACKUP_PORT}}
MONGODB_BACKUP_USER=${MONGODB_BACKUP_USER:-${MONGODB_BACKUP_ENV_MONGODB_USER}}
MONGODB_BACKUP_PASS=${MONGODB_BACKUP_PASS:-${MONGODB_BACKUP_ENV_MONGODB_PASS}}
...
# echo ${MONGODB_BACKUP_HOST}
# echo ${MONGODB_BACKUP_PORT}
# echo ${MONGODB_BACKUP_USER}
# echo ${MONGODB_BACKUP_PASS}
# echo ${EXTRA_BACKUP_OPTS}
